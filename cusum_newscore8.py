...
df1 = pandas.read_excel('FileName_3fB5.xlsx', sheet_name='Sheet1', header=None)
#df1 = np.genfromtxt("FileName_3fB5.xlsx", delimiter=";", skip_header=1)
#df1.as_matrix()
df2 = pandas.read_excel('FileName_ITa_B3B9.xlsx', sheet_name='Sheet1', header=None)
df3 = pandas.read_excel('FileName_LooseaB3B9.xlsx', sheet_name='Sheet1', header=None)
...
#dset0 = df.as_matrix()
#your_matrix1 = pe.get_array(file_name=FileName_3fB5.xlsx) # done
#your_matrix2 = pe.get_array(file_name=FileName_ITa_B3B9.xlsx) # done
#your_matrix3 = pe.get_array(file_name=FileName_LooseaB3B9.xlsx) # done


dset=(np.asarray(ddf[1100:1400])-0.97636948)*1000000000
print(dset)
...
np.savetxt('data.csv', (dset), delimiter=',')
