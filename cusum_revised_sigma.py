...
dset=bilateralFtr1D(dset, ss/2,  dd/2)
...
plt.gca().set_title('Raw data', fontsize=fs)
...
plt.gca().set_title('Abrupt change score:MB-CUSUM', fontsize=fs)
plt.xlabel('Time', fontsize=fs)
plt.ylabel('Score', fontsize=fs)

plt.subplot(413)
plt.plot(np.arange(1, 301, 1),15-maxsum3, 'r',linewidth=5.0)
plt.gca().set_title('Abrupt change score:BF+MB-CUSUM', fontsize=fs)
plt.xlabel('Time', fontsize=fs)
plt.ylabel('Score', fontsize=fs)
...
plt.gca().set_title('Abrupt change score:EP-CUSUM', fontsize=fs)
plt.xlabel('Time', fontsize=fs)
plt.ylabel('Score', fontsize=fs)
